...
def main():
    ...
    # robot.linear_absolute(absolute_position, speed=300, sequence_id=1)
    ...
    # Optional: Converting coordinates (IKPy)
    cartesian = robot.read_cartesian_coordinates()
    joints = robot.convert_coordinates(cartesian, robot_model_urdf_path="robot_models/crx10ial/crx10ial.urdf", from_type="cartesian", to_type="joint")
    print("Cartesian coordinates:", cartesian)
    print("Joint coordinates:", joints)
    cartesian = robot.convert_coordinates(joints, robot_model_urdf_path="robot_models/crx10ial/crx10ial.urdf", from_type="joint", to_type="cartesian")
